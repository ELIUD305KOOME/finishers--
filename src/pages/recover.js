...
const reviews = [
  {
    ...
    rating: 5,
    backgroundImage:
      "https://m.media-amazon.com/images/I/71pzobSvqVL._AC_UF1000,1000_QL80_.jpg",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    rating: 5,
    backgroundImage:
      "https://www.edgebrookdermatology.com/wp-content/uploads/2023/06/50CD2B9F-6014-4B61-A9B9-5A9949E1A434-scaled.jpg",
  },
  {
    id: 5,
...
const Recovery = () => {
  ...
  return (
    <div className="relative w-full flex  h-full  items-center justify-center bg-white py-10">
      <div className="relative overflow-hidden h-full w-full max-w-6xl">
        <div
        ...
        >
          {reviews.map((review) => (
            <div
              key={review.id}
              className="min-w-full px-4 h-full sm:px-4 lg:px-6"
            >
              <div
                className="relative rounded-md shadow-lg overflow-hidden h-[40vh] lg:h-[70vh] flex items-end justify-center"
                style={{
              ...
              >
                <div className="bg-white/70 w-full text-xs p-4 text-center rounded-b-md">
                  <h3 className="text-orange-800 text-xs font-semibold lg:text-lg">
                    {review.name}
                  </h3>
                  <p className="text-gray-700 text-xs mt-1">{review.review}</p>
                  <div className="flex justify-center h-full mt-2 text-yellow-400">
        ...
        <div className="flex justify-center mt-4">
          {reviews.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 mx-1 rounded-full ${index === activeReview ? "bg-orange-700" : "bg-gray-300"}`}
            ></button>
          ))}
        </div>
      </div>
